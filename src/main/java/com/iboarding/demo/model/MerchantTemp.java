...
public class MerchantTemp {
	...
	public MerchantTemp(int merchant_id, int user_id, String business_type, String merchant_category,
			String merchant_size, String currency, int minimum, int maximum, int pkg_id, String total_amount,
			String average_ticket, String ecomm_turnover, String annualcard_turnover, String dcc_turnover,
			String card_capture, String one_zero_nine_nine, String payment_advice_required, String payment_advice_type,
